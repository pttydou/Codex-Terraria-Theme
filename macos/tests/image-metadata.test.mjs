...
const forest = await fs.readFile(path.join(
  macosRoot,
  "local-presets",
  "preset-terraria-forest-day",
  "background.png",
));
assert.deepEqual(readImageMetadata(forest, ".png"), {
  width: 1024,
  height: 838,
  ratio: 1024 / 838,
  wide: false,
...
const malformedPng = Buffer.from(forest);
malformedPng[0] = 0;
...
assert.deepEqual(readImageMetadata(jpeg, ".jpg"), {
  width: 1920,
  height: 1200,
  ratio: 1.6,
  wide: false,
