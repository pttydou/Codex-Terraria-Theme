...
echo "已保存的主题"
echo "-- Codex 官方原版 | bash=\"$RESTORE\" param1=\"--restore-base-theme\" param2=\"--restart-codex\" terminal=false refresh=true"
theme_count=0
...
echo "---"
echo "完全恢复（官方原版） | bash=\"$RESTORE\" param1=\"--restore-base-theme\" param2=\"--restart-codex\" terminal=false refresh=true"
echo "---"
